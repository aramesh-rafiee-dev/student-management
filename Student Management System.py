...
for student in students:
    print("-" * 60)
    print(f"Name: {student['Name']:<12} Age: {student['Age']:<5} ID: {student['Id']:<8} Class: {student['Student_class']}")
    print(f"Math: {student['Math']:<8} English: {student['English']:<8} Science: {student['Science']}")
    print(f"Average: {student['Average']:.1f}   Grade: {student['Grade']}   Status: {student['Status']}")
...
print(f"Highest average: {BestStudents['Average']:.1f}")
...
print(f"Lowest average: {WorstStudent['Average']:.1f}")
